...
$xoopsOption['template_main'] = 'downloadse_topten.html';
...
$arr=array();
$result=$xoopsDB->query("SELECT cid, title FROM ".$xoopsDB->prefix("downloadse_cat")." WHERE pid=0");
$e = 0;
$rankings = array();
while(list($cid,$ctitle)=$xoopsDB->fetchRow($result)){
	$rankings[$e]['title'] = sprintf(_MD_TOP10, $myts->htmlSpecialChars($ctitle));
	$query = "SELECT lid, cid, title, hits, rating, votes FROM ".$xoopsDB->prefix("downloadse_downloads")." WHERE status>0 AND (cid=$cid";
