...
function downloadse_search($queryarray, $andor, $limit, $offset, $userid){
	global $xoopsDB;
	$sql = "SELECT d.lid,d.cid,d.title,d.submitter,d.date,t.description FROM ".$xoopsDB->prefix("downloadse_downloads")." d LEFT JOIN ".$xoopsDB->prefix("downloadse_text")." t ON t.lid=d.lid WHERE status>0";
	if ( $userid != 0 ) {
